...
export default function LeftMenu({ setActiveItem, setIrisVisble }) {
    // const [irisVisble, setIrisVisble] = createSignal(false);

    const handleClick = (e) => {
        let irisKey = e.currentTarget.getElementsByTagName('div')[0].innerText;
        setActiveItem(irisKey);
        if(irisKey != 'Dashbord'){
            setIrisVisble(true)
        }else{
            setIrisVisble(false)
    ...
    return (
        <div class="">
            <ul role="list" class="divide-y  divide-gray-100 rounded-md border border-gray-200">
                ...
                <div>
                        <li class="flex items-center justify-between py-4 pl-8 pr-5 text-sm leading-6" onClick={handleClick}>
                            <div class="ml-4 flex-shrink-0">
