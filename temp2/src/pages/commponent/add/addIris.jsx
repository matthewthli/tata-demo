...
export default function AddIris({activeItem, setRefreshFlag, irisVisble, setIrisVisble}) {
  ...
  createEffect(() => {
    ...
    setIrisDetail(activeItem && activeItem())
            ...
            {/* <form action="" method="POST" class="mx-auto  max-w-xl sm:mt-10"> */}
                <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2.5">
                            <input type="text" name="summery" id="summery" autocomplete="organization" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2.5">
                            <input type="text" name="projectName" id="projectName" autocomplete="organization" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
                    {/* </Show> */}
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2.5">
                            <input type="text" name="department" id="department" autocomplete="email" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
                    {/* </Show> */}
                    {/* <Show when={showField('buildVmIp')}> */}
                        <div>
                            ...
                            <div class="mt-2.5">
                                <input type="text" name="buildVmIp" id="buildVmIp" autocomplete="organization" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                    {/* </Show> */}
